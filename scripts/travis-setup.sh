...
then
    # Building our own Docker Container to include the IUC conda channel. This should be fast, because we just configure conda.
    cd scripts
    docker build -t bioconda/bioconda-builder .
else
